...
model = load_model('V5/models/2-V5-model_2023-06-18-23-03.h5', compile=False)
model.compile(optimizer='adam', loss='mean_squared_error')

# Load the model weights
model.load_weights('V5/models/V5-weights_2023-06-18-23-03.h5')

# Load the scaler
scaler = joblib.load('V5/models/V5-scaler_2023-06-18-23-03.joblib')
